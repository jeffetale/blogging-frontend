...
export default function AboutMeSection2() {
  return (
    <>
      {/* about me section */}
      <div className="sm:gap-[34px] gap-[68px] flex flex-col items-center self-stretch px-14 md:px-5 sm:px-4">
        <div className="max-w-[1560px] mx-auto w-full">
                    ...
                    <div className="h-[466px] relative self-stretch">
                      <div className="absolute left-0 right-0 top-0 mx-auto flex flex-col items-start">
                        <Heading
                          size="headings"
                          as="h2"
                          className="sm:text-[24px] md:text-[26px] lg:text-[27px] text-[32px] tracking-[0.96px] font-semibold text-amber-900"
                        >
                          Jeff Etale
                        </Heading>
                        <Text
                          ...
                          as="h1"
                          className="md:text-[48px] lg:text-[48px] text-[100px] tracking-[3.00px] mt-[-36px] relative font-bold text-black-900"
                        >
                          Software
                        </Text>
                      </div>
                      <div className="bottom-[-0.70px] absolute left-0 right-0 mx-auto flex flex-1 flex-col items-end">
                        <Text
                          size="main_heading_h1"
                          as="h1"
                          className="md:text-[48px] lg:text-[48px] text-[100px] tracking-[3.00px] mr-20 font-bold text-black-900 md:mr-0"
                        >
                          Engineer
                        </Text>
                        <div className="mt-[-72px] relative flex flex-col items-start self-stretch">
                          <Text
                            size="main_heading_h1"
                            as="h1"
                            className="md:text-[48px] lg:text-[48px] z-[1] text-[100px] tracking-[3.00px] ml-[202px] relative font-bold text-black-900 md:ml-0"
                          >
                            &{" "}
                          </Text>
                          <Text
                            size="main_heading_h1"
                            as="h1"
                            className="md:text-[48px] lg:text-[48px] text-[100px] tracking-[3.00px] mt-[-56px] relative font-bold text-black-900 self-end"
                          >
                            Ethical Hacker
                          </Text>
                        </div>
          ...
          <div className="w-[36%] md:w-full">
            <div className="flex flex-col items-center">
              ...
              />
              <div className="columnlayer0cop_border rounded-[242px] mr-[30px] mt-[-220px] relative ml-12 self-stretch bg-white-a700 shadow-bs5 md:mx-0">
                <Img
        ...
        <div className="max-w-[1594px] mx-auto flex w-full items-center justify-center gap-7 md:flex-col">
          <div className="h-[674px] relative flex-1 md:w-full md:flex-none md:self-stretch">
            <div className="columnbackgroun_border rounded-[272px] right-[9%] bottom-[0.81px] w-[74%] absolute m-auto bg-white-a700 shadow-bs4">
              <Img
